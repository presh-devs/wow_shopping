...
import 'package:wow_shopping/features/home/providers/home_page_providers.dart';
...
class SliverTopSelling extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final topSelling = ref.watch(topSellingProvider);
    return topSelling.when(data: (data) {
